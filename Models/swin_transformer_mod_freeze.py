...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=6,
                 embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
                 window_size=7, mlp_ratio=4., qkv_bias=True,
                 drop_rate=0.1, attn_drop_rate=0.1, drop_path_rate=0.1,
                 norm_layer=nn.LayerNorm, ape=False, patch_norm=True,
                 use_checkpoint=False, pretrained_window_sizes=[0, 0, 0, 0],
                 freeze_until_layer=3, **kwargs):  # Add freeze_until_layer parameter
        ...
        # Call the freeze function here
        self.freeze_layers(freeze_until_layer)

    # Add the freeze_layers function here
    def freeze_layers(self, freeze_until_layer):
        """
        Freeze layers up to the specified number.
        
        Args:
            freeze_until_layer (int): The number of layers to freeze.
        """
